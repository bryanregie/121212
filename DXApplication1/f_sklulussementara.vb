...
Public Class f_sklulussementara
 ' Dim myConnectionString As String
    ...
    Private Sub ConnectMysql(nim As String)
        ...
        Dim sk As String
        If ComboBoxEdit1.EditValue = "Indonesia" Then
            sk = "sklulus_temp"
        Else
            sk = "sklulus_temp_eng"
        End If
        ...
        '// double nosurat
        Dim ns As String = KweryRvalue("select nosurat from satr0020 where idnim = '" & TextEdit1.EditValue & "' and type='SK Lulus Sementara' order by nosurat desc ", "nosurat")
        ...
        End If
        '===========================
        dA3 = New MySqlDataAdapter("select *,now() as tgl from cmdnodok where kodedok ='SKLS'", conn)
    ...
    Private Sub WindowsUIButtonPanel1_ButtonClick(sender As Object, e As DevExpress.XtraBars.Docking2010.ButtonEventArgs) Handles WindowsUIButtonPanel1.ButtonClick
        ...
        Try
            ...
            Class1.status = ""
            Class1.note = ""
            Class1.stype = "SK Lulus Sementara"
        ...
        Select Case e.Button.Properties.Tag
            ...
            Case 1
                ...
                Try
                    Class1.report = XtraReport.FromFile(Application.StartupPath + "\rpx\r_lulussementara.repx", True)
                ...
                textOut(vbNewLine, rtb)
                If ComboBoxEdit1.EditValue = "Indonesia" Then
                    textOut(vbTab + GridView2.GetRowCellValue(0, "par5") + vbTab + vbTab + ": ", rtb)
                    ...
                    textOut(GridView1.GetRowCellValue(0, "gelarind") + ". ", rtb, New Font("Arial Narrow", 10, FontStyle.Bold))
                Else
                    textOut(vbTab + GridView2.GetRowCellValue(0, "par5") + vbTab + vbTab + vbTab + ": ", rtb)
                    textOut(GridView1.GetRowCellValue(0, "meprogdiing") + vbNewLine, rtb)
                    textOut(vbNewLine, rtb)
                    textOut(GridView2.GetRowCellValue(0, "par6") + "  ", rtb)
                    textOut(GridView1.GetRowCellValue(0, "meprogdiing") + "  ", rtb, New Font("Arial Narrow", 10, FontStyle.Bold))
                    textOut(GridView2.GetRowCellValue(0, "par7") + "  ", rtb)
                    textOut(GridView1.GetRowCellValue(0, "mekonsening") + ". ", rtb, New Font("Arial Narrow", 10, FontStyle.Bold))
                    textOut(GridView2.GetRowCellValue(0, "par8") + "  ", rtb)
                    textOut(GridView1.GetRowCellValue(0, "gelaring") + ". ", rtb, New Font("Arial Narrow", 10, FontStyle.Bold))
                End If
